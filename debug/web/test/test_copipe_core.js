...
(function (test_copipe_core) {
    ...
    var initialize = function (copipe) {
        ...
        // convert
        numberToString = copipe.numberToString, numToString = copipe.numToString, numToStr = copipe.numToStr, stringToNumber = copipe.stringToNumber, strToNumber = copipe.strToNumber, strToNum = copipe.strToNum, stringToInteger = copipe.stringToInteger, strToInteger = copipe.strToInteger, strToInt = copipe.strToInt);
        /**
         * 名前空間でルート公開されていない関数の展開
         */
        (_a = copipe.string, includes = _a.includes, matchFormat = _a.matchFormat);
        (checkEqual = copipe.test.checkEqual);
    };
    var type;
    (function (type) {
        type.test_isUndefined = function () {
            var u1;
            var n1 = null;
            var v1 = 1;
        ...
        type.test_isFunction = function () {
            checkEqual(true, isFunction(function () { }));
            checkEqual(false, isFunction({}));
            checkEqual(true, isFunction(function () { }, type.test_isFunction));
            checkEqual(false, isFunction({}, type.test_isFunction));
            checkEqual(true, isFunctionArray([function () { }, type.test_isFunction]));
            checkEqual(false, isFunctionArray([{}, type.test_isFunction]));
        };
        type.test_isObject = function () {
    ...
    (function (compare) {
        compare.test_match = function () {
            ...
            checkEqual(true, match('abc', [function (value) { return value.startsWith('a'); }]), 'test_match 7');
            checkEqual(false, match('abc', [function (value) { return value.startsWith('b'); }]), 'test_match 8');
            // 通常引数 数値
            ...
            checkEqual(true, match(100, [function (value) { return 100 <= value; }]), 'test_match 7');
            checkEqual(false, match(99, [function (value) { return 100 <= value; }]), 'test_match 8');
            // 例外判定
            ...
            checkEqual(true, match({
                value: 'abc', compareArray: [function (value) { return value.startsWith('a'); }]
            }), 'test_match param 7');
            checkEqual(false, match({
                value: 'abc', compareArray: [function (value) { return value.startsWith('b'); }]
            }), 'test_match param 8');
            // パラメータ引数 数値
            checkEqual(false, match({
            ...
            checkEqual(true, match({
                value: 100, compareArray: [function (value) { return 100 <= value; }]
            }), 'test_match param 7');
            checkEqual(false, match({
                value: 99, compareArray: [function (value) { return 100 <= value; }]
            }), 'test_match param 8');
            // 例外判定
            checkEqual(false, isThrown(function () {
                match({
    ...
    var convert;
    (function (convert) {
        convert.test_numberToString = function () {
            // 正数
        ...
        convert.test_stringToNumber = function () {
            // 整数
        ...
        convert.test_stringToInteger = function () {
            // 整数
    ...
    (function (string) {
        ...
        string.test_matchFormat = function () {
    ...
    test_copipe_core.run = function (copipe) {
        ...
        var test_numberToString = convert.test_numberToString, test_stringToNumber = convert.test_stringToNumber, test_stringToInteger = convert.test_stringToInteger;
        var test_includes = string.test_includes, test_matchFormat = string.test_matchFormat;
